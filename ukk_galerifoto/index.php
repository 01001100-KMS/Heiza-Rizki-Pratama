...
<h>
    ...
    <style>
    .bg-image {
      background-image: url('assets/img/Lamborghini_contach.jpg');
      height: 100vh;
...
<body class="bg-image">
    ...
    <nav class="navbar navbar-expand-lg" style="background-color: #00000000">
        <div class="container">
                                        ...
                                        <div class="col-md-4">
                                            <div class="m-2">
                                                <div class="overflow-auto">
                                                    ...
                                                    <?php
                                                    $fotoid = $data['fotoid'];
                                                    $komentar = mysqli_query($koneksi, "SELECT * FROM komentar_foto INNER JOIN user ON komentarfoto.userid=user.userid WHERE komentarfoto.fotoid='$fotoid'");
